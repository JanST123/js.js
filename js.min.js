...
js.updateMetaTag=function(b,a){b=b.replace(":","\\:");var c=document.createElement("DIV");c.innerHTML=a;a=c.textContent;return"undefined"!=typeof document.head&&"function"==typeof document.head.querySelector&&(c=document.head.querySelector("meta[name="+b+"],meta[http-equiv="+b+"],meta[property="+b+"]"),c||null===a||(c=js.addEl(document.head,"meta"),c.setAttribute("name",b)),c)?(null===a?js.removeEl(c):c.setAttribute("content",a),!0):!1};
